...
_lr_productions = [
  ...
  ('code -> INICIO DOSPUNTOS cuerpo FIN PUNTOCOMA procedimiento','code',6,'p_Code','SintacticAnalizer.py',22),
  ('cuerpo -> variable','cuerpo',1,'p_cuerpo','SintacticAnalizer.py',29),
  ('cuerpo -> expresion','cuerpo',1,'p_cuerpo','SintacticAnalizer.py',30),
  ('variable -> variable1 cuerpo','variable',2,'p_Variable','SintacticAnalizer.py',37),
  ('variable -> variable2 cuerpo','variable',2,'p_Variable','SintacticAnalizer.py',38),
  ('variable -> empty empty','variable',2,'p_Variable','SintacticAnalizer.py',39),
  ('variable1 -> DCL ID PUNTOCOMA','variable1',3,'p_Variable1','SintacticAnalizer.py',46),
  ('variable2 -> DCL ID DEFAULT NUMERO PUNTOCOMA','variable2',5,'p_Variable2','SintacticAnalizer.py',53),
  ('expresion -> condicion1 expresion','expresion',2,'p_expresion','SintacticAnalizer.py',60),
  ('expresion -> condicion2 expresion','expresion',2,'p_expresion','SintacticAnalizer.py',61),
  ('expresion -> repita expresion','expresion',2,'p_expresion','SintacticAnalizer.py',62),
  ('expresion -> hacer expresion','expresion',2,'p_expresion','SintacticAnalizer.py',63),
  ('expresion -> funcion expresion','expresion',2,'p_expresion','SintacticAnalizer.py',64),
  ('expresion -> llamarProc expresion','expresion',2,'p_expresion','SintacticAnalizer.py',65),
  ('expresion -> empty empty','expresion',2,'p_expresion','SintacticAnalizer.py',66),
  ('condicion1 -> ENCASO cond1Aux1 FINENCASO PUNTOCOMA','condicion1',4,'p_condicion1','SintacticAnalizer.py',76),
  ('cond1Aux1 -> cond1Aux2 SINO LLAVE_IZQ expresion LLAVE_DER','cond1Aux1',5,'p_cond1Aux1','SintacticAnalizer.py',83),
  ('cond1Aux1 -> empty empty empty empty empty','cond1Aux1',5,'p_cond1Aux1','SintacticAnalizer.py',84),
  ('cond1Aux2 -> CUANDO ID condicion sentencia ENTONS LLAVE_IZQ expresion LLAVE_DER cond1Aux2','cond1Aux2',9,'p_cond1Aux2','SintacticAnalizer.py',94),
  ('cond1Aux2 -> empty empty empty empty empty empty empty empty empty','cond1Aux2',9,'p_cond1Aux2','SintacticAnalizer.py',95),
  ('condicion2 -> ENCASO ID cond2Aux1 FINENCASO PUNTOCOMA','condicion2',5,'p_condicion2','SintacticAnalizer.py',107),
  ('cond2Aux1 -> cond2Aux2 SINO LLAVE_IZQ expresion LLAVE_DER','cond2Aux1',5,'p_cond2Aux1','SintacticAnalizer.py',114),
  ('cond2Aux1 -> empty empty empty empty empty','cond2Aux1',5,'p_cond2Aux1','SintacticAnalizer.py',115),
  ('cond2Aux2 -> CUANDO condicion sentencia ENTONS LLAVE_IZQ expresion LLAVE_DER cond2Aux2','cond2Aux2',8,'p_cond2Aux2','SintacticAnalizer.py',125),
  ('cond2Aux2 -> empty empty empty empty empty empty empty empty','cond2Aux2',8,'p_cond2Aux2','SintacticAnalizer.py',126),
  ('condicion -> IGUAL','condicion',1,'p_condicion','SintacticAnalizer.py',138),
  ('condicion -> MAYOR','condicion',1,'p_condicion','SintacticAnalizer.py',139),
  ('condicion -> MENOR','condicion',1,'p_condicion','SintacticAnalizer.py',140),
  ('condicion -> DIFERENTE','condicion',1,'p_condicion','SintacticAnalizer.py',141),
  ('condicion -> MAYORIGUAL','condicion',1,'p_condicion','SintacticAnalizer.py',142),
  ('condicion -> MENORIGUAL','condicion',1,'p_condicion','SintacticAnalizer.py',143),
  ('sentencia -> ID','sentencia',1,'p_sentencia','SintacticAnalizer.py',151),
  ('sentencia -> NUMERO','sentencia',1,'p_sentencia','SintacticAnalizer.py',152),
  ('repita -> REPITA LLAVE_IZQ expresion LLAVE_DER HASTAENCONTRAR ID condicion sentencia PUNTOCOMA','repita',9,'p_repita','SintacticAnalizer.py',159),
  ('hacer -> DESDE ID IGUAL sentencia HASTA sentencia HAGA LLAVE_IZQ expresion LLAVE_DER FINDESDE PUNTOCOMA','hacer',12,'p_hacer','SintacticAnalizer.py',166),
  ('funcion -> Aleatorio','funcion',1,'p_funcion','SintacticAnalizer.py',173),
  ('funcion -> Mover','funcion',1,'p_funcion','SintacticAnalizer.py',174),
  ('funcion -> funcionAlge','funcion',1,'p_funcion','SintacticAnalizer.py',175),
  ('Aleatorio -> ALEATORIO PARENTESIS_IZQ PARENTESIS_DER PUNTOCOMA','Aleatorio',4,'p_aleatorio','SintacticAnalizer.py',182),
  ('Mover -> MOVER PARENTESIS_IZQ paramMover PARENTESIS_DER PUNTOCOMA','Mover',5,'p_mover','SintacticAnalizer.py',189),
  ('paramMover -> AF','paramMover',1,'p_ParamMover','SintacticAnalizer.py',196),
  ('paramMover -> F','paramMover',1,'p_ParamMover','SintacticAnalizer.py',197),
  ('paramMover -> DFA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',198),
  ('paramMover -> IFA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',199),
  ('paramMover -> DFB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',200),
  ('paramMover -> IFB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',201),
  ('paramMover -> A','paramMover',1,'p_ParamMover','SintacticAnalizer.py',202),
  ('paramMover -> DAA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',203),
  ('paramMover -> IAA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',204),
  ('paramMover -> DAB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',205),
  ('paramMover -> IAB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',206),
  ('paramMover -> AA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',207),
  ('funcionAlge -> INC PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA','funcionAlge',7,'p_funcion_Alge','SintacticAnalizer.py',214),
  ('funcionAlge -> DEC PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA','funcionAlge',7,'p_funcion_Alge','SintacticAnalizer.py',215),
  ('funcionAlge -> INI PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA','funcionAlge',7,'p_funcion_Alge','SintacticAnalizer.py',216),
  ('procedimiento -> PROC ID PARENTESIS_IZQ parametro PARENTESIS_DER INICIOPROC DOSPUNTOS expresion FINPROC PUNTOCOMA procedimiento','procedimiento',11,'p_procedimiento','SintacticAnalizer.py',224),
  ('procedimiento -> empty empty empty empty empty empty empty empty empty empty empty','procedimiento',11,'p_procedimiento','SintacticAnalizer.py',225),
  ('parametro -> ID COMA parametro','parametro',3,'p_parametro','SintacticAnalizer.py',237),
  ('parametro -> ID empty empty','parametro',3,'p_parametro','SintacticAnalizer.py',238),
  ('parametro -> NUMERO COMA parametro','parametro',3,'p_parametro','SintacticAnalizer.py',239),
  ('parametro -> NUMERO empty empty','parametro',3,'p_parametro','SintacticAnalizer.py',240),
  ('parametro -> empty empty empty','parametro',3,'p_parametro','SintacticAnalizer.py',241),
  ('llamarProc -> LLAMAR ID PARENTESIS_IZQ parametro PARENTESIS_DER PUNTOCOMA','llamarProc',6,'p_llamarProc','SintacticAnalizer.py',252),
  ('empty -> <empty>','empty',0,'p_empty','SintacticAnalizer.py',259),
]
