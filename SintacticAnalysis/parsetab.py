...
_lr_productions = [
  ...
  ('condicion1 -> ENCASO cond1Aux1 FINENCASO PUNTOCOMA','condicion1',4,'p_condicion1','SintacticAnalizer.py',124),
  ('condicion2 -> ENCASO ID cond2Aux1 FINENCASO PUNTOCOMA','condicion2',5,'p_condicion2','SintacticAnalizer.py',130),
  ('cond2Aux1 -> cond2Aux2 SINO LLAVE_IZQ expresion LLAVE_DER','cond2Aux1',5,'p_cond2Aux1','SintacticAnalizer.py',138),
  ('cond2Aux1 -> empty empty empty empty empty','cond2Aux1',5,'p_cond2Aux1','SintacticAnalizer.py',139),
  ('cond1Aux1 -> cond1Aux2 SINO LLAVE_IZQ expresion LLAVE_DER','cond1Aux1',5,'p_cond1Aux1','SintacticAnalizer.py',148),
  ('cond1Aux1 -> empty empty empty empty empty','cond1Aux1',5,'p_cond1Aux1','SintacticAnalizer.py',149),
  ('cond1Aux2 -> empty','cond1Aux2',1,'p_cond1Aux2_empty','SintacticAnalizer.py',160),
  ('cond1Aux2 -> CUANDO ID condicion sentencia ENTONS LLAVE_IZQ expresion LLAVE_DER cond1Aux2','cond1Aux2',9,'p_cond1Aux2','SintacticAnalizer.py',166),
  ('cond2Aux2 -> CUANDO condicion sentencia ENTONS LLAVE_IZQ expresion LLAVE_DER cond2Aux2','cond2Aux2',8,'p_cond2Aux2','SintacticAnalizer.py',178),
  ('cond2Aux2 -> empty','cond2Aux2',1,'p_cond2Aux2_empty','SintacticAnalizer.py',189),
  ('condicion -> IGUAL','condicion',1,'p_condicion','SintacticAnalizer.py',199),
  ('condicion -> MAYOR','condicion',1,'p_condicion','SintacticAnalizer.py',200),
  ('condicion -> MENOR','condicion',1,'p_condicion','SintacticAnalizer.py',201),
  ('condicion -> DIFERENTE','condicion',1,'p_condicion','SintacticAnalizer.py',202),
  ('condicion -> MAYORIGUAL','condicion',1,'p_condicion','SintacticAnalizer.py',203),
  ('condicion -> MENORIGUAL','condicion',1,'p_condicion','SintacticAnalizer.py',204),
  ('sentencia -> ID','sentencia',1,'p_sentencia','SintacticAnalizer.py',212),
  ('sentencia -> NUMERO','sentencia',1,'p_sentencia','SintacticAnalizer.py',213),
  ('repita -> REPITA LLAVE_IZQ expresion LLAVE_DER HASTAENCONTRAR ID condicion sentencia PUNTOCOMA','repita',9,'p_repita','SintacticAnalizer.py',220),
  ('hacer -> DESDE ID IGUAL sentencia HASTA sentencia HAGA LLAVE_IZQ expresion LLAVE_DER FINDESDE PUNTOCOMA','hacer',12,'p_hacer','SintacticAnalizer.py',229),
  ('funcion -> Aleatorio','funcion',1,'p_funcion','SintacticAnalizer.py',238),
  ('funcion -> Mover','funcion',1,'p_funcion','SintacticAnalizer.py',239),
  ('funcion -> funcionAlge','funcion',1,'p_funcion','SintacticAnalizer.py',240),
  ('Aleatorio -> ALEATORIO PARENTESIS_IZQ PARENTESIS_DER PUNTOCOMA','Aleatorio',4,'p_aleatorio','SintacticAnalizer.py',247),
  ('Mover -> MOVER PARENTESIS_IZQ paramMover PARENTESIS_DER PUNTOCOMA','Mover',5,'p_mover','SintacticAnalizer.py',256),
  ('paramMover -> AF','paramMover',1,'p_ParamMover','SintacticAnalizer.py',265),
  ('paramMover -> F','paramMover',1,'p_ParamMover','SintacticAnalizer.py',266),
  ('paramMover -> DFA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',267),
  ('paramMover -> IFA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',268),
  ('paramMover -> DFB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',269),
  ('paramMover -> IFB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',270),
  ('paramMover -> A','paramMover',1,'p_ParamMover','SintacticAnalizer.py',271),
  ('paramMover -> DAA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',272),
  ('paramMover -> IAA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',273),
  ('paramMover -> DAB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',274),
  ('paramMover -> IAB','paramMover',1,'p_ParamMover','SintacticAnalizer.py',275),
  ('paramMover -> AA','paramMover',1,'p_ParamMover','SintacticAnalizer.py',276),
  ('funcionAlge -> INC PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA expresion','funcionAlge',8,'p_funcion_Alge','SintacticAnalizer.py',283),
  ('funcionAlge -> DEC PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA expresion','funcionAlge',8,'p_funcion_Alge','SintacticAnalizer.py',284),
  ('funcionAlge -> INI PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA expresion','funcionAlge',8,'p_funcion_Alge','SintacticAnalizer.py',285),
  ('funcionAlge -> INC PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA','funcionAlge',7,'p_funcion_Alge2','SintacticAnalizer.py',293),
  ('funcionAlge -> DEC PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA','funcionAlge',7,'p_funcion_Alge2','SintacticAnalizer.py',294),
  ('funcionAlge -> INI PARENTESIS_IZQ ID COMA sentencia PARENTESIS_DER PUNTOCOMA','funcionAlge',7,'p_funcion_Alge2','SintacticAnalizer.py',295),
  ('procedimiento -> PROC ID PARENTESIS_IZQ parametro PARENTESIS_DER INICIOPROC DOSPUNTOS expresion FINPROC PUNTOCOMA procedimiento','procedimiento',11,'p_procedimiento','SintacticAnalizer.py',304),
  ('procedimiento -> empty empty empty empty empty empty empty empty empty empty empty','procedimiento',11,'p_procedimiento','SintacticAnalizer.py',305),
  ('parametro -> ID COMA parametro','parametro',3,'p_parametro','SintacticAnalizer.py',317),
  ('parametro -> ID empty empty','parametro',3,'p_parametro','SintacticAnalizer.py',318),
  ('parametro -> NUMERO COMA parametro','parametro',3,'p_parametro','SintacticAnalizer.py',319),
  ('parametro -> NUMERO empty empty','parametro',3,'p_parametro','SintacticAnalizer.py',320),
  ('parametro -> empty empty empty','parametro',3,'p_parametro','SintacticAnalizer.py',321),
  ('llamarProc -> LLAMAR ID PARENTESIS_IZQ parametro PARENTESIS_DER PUNTOCOMA','llamarProc',6,'p_llamarProc','SintacticAnalizer.py',331),
  ('empty -> <empty>','empty',0,'p_empty','SintacticAnalizer.py',338),
]
