...
class PythonHighlighter (QSyntaxHighlighter):
    ...
    # Python keywords
    keywords = [
        'DCL', 'DEFAULT', 'Inicio', 'EnCaso', 'Cuando', 'EnTons',
        'SiNo', 'Fin-EnCaso', 'Repita', 'HastaEncontrar', 'Desde', 'Hasta',
        'Haga', 'Fin-Desde', 'Fin', 'fin', 'inicio', 'INC',
        'DEC', 'INI', 'Mover', 'Aleatorio', 'Llamar',
        'AF', 'F', 'DFA', 'IFA', 'DFB',
        'IFB', 'A', 'DAA','IAA','DAB','IAB','AA'
    ]
    Procedimientos = ['Proc']
    Declaraciones = ['DCL']
    ...
    def __init__(self, document):
        ...
        rules += [(r'\b%s\b' % w, 0, STYLES['Procedimientos'])
                  for w in PythonHighlighter.Procedimientos]
        rules += [(r'\b%s\b' % w, 0, STYLES['DCL'])
                  for w in PythonHighlighter.Declaraciones]
